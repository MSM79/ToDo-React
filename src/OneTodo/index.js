...
import { Checkbox, Row, Col, Badge, Popconfirm, message } from 'antd';
import './style.css';
...
function OneTodo({ todo }) {
  ...
  return (
    <Row align="middle" justify="center">
      ...
      <Col style={{ marginTop: 16 }} id="cardTodo">
        <Row>
          <Col>
            <Row align="middle">
              <Col>
                <Badge status={process} />
                <span class="spantitle">{todo.name}</span>
              </Col>
            </Row>
            {/* <Row>
              <Col className="todoIcon">
                <Row>
                  <svg
                    id="Outline"
